...
class TestLancamento {
	...
	private static void save() {
		...
		lancamento.getCategoriaLancamento().setId(1L);
		lancamento.getCartao().get().setId(1L);

		lancamento2.getConta().setSaldo(199.50);
		lancamento2.getConta().setId(2L);
		lancamento2.getConta().getUsuario().setId(2L);
		lancamento2.getCategoriaLancamento().setId(1L);
		lancamento2.getCartao().get().setId(1L);
